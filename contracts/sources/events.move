/// Event definitions for all war operations and state changes.
///
/// Emitted by registry, config, schedule, and snapshots modules to track
/// war lifecycle, configuration updates, and snapshot commits.
