/// Game rule constants: source of truth modes, assembly families, storage modes, and control states.
///
/// Provides validation functions and named constants for all rule enums.
/// Used by config, registry, schedule, and snapshots modules.
...
/// Returns the target kind for system config changes.
public fun target_kind_system_config(): u8 {
    TARGET_KIND_SYSTEM_CONFIG
}
