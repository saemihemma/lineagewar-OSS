/// Scheduled config changes: creation, cancellation, and shared object management.
///
/// Manages ScheduledChange (key, store) with target kind, config object ID, and effective time.
/// Admin-operated via WarAdminCap authorization. Validates target kind against rules.
...
/// Schedules a config change to take effect at a specified time.
...
/// Cancels a previously scheduled config change.
...
/// Shares a scheduled change as a shared object.
