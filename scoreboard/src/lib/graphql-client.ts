 ...
 *
 * Configuration:
 * - Base URL: VITE_SUI_GRAPHQL_URL env var, fallback to Sui mainnet GraphQL endpoint
 * - Automatic error handling with typed response parsing
 */

const GRAPHQL_URL =
  import.meta.env.VITE_SUI_GRAPHQL_URL ?? "https://sui-mainnet.mystenlabs.com/graphql";
